...
exports.ConvexQueryClient = exports.optimisticallyUpdateValueInPaginatedQuery = exports.useConvexAuth = exports.useConvex = exports.useConvexAction = exports.useConvexMutation = exports.useConvexPaginatedQuery = exports.useConvexQueries = exports.useConvexQuery = void 0;
exports.convexQuery = convexQuery;
exports.convexAction = convexAction;
...
Object.defineProperty(exports, "useConvexQuery", { enumerable: true, get: function () { return react_2.useQuery; } });
Object.defineProperty(exports, "useConvexQueries", { enumerable: true, get: function () { return react_2.useQueries; } });
Object.defineProperty(exports, "useConvexPaginatedQuery", { enumerable: true, get: function () { return react_2.usePaginatedQuery; } });
Object.defineProperty(exports, "useConvexMutation", { enumerable: true, get: function () { return react_2.useMutation; } });
Object.defineProperty(exports, "useConvexAction", { enumerable: true, get: function () { return react_2.useAction; } });
Object.defineProperty(exports, "useConvex", { enumerable: true, get: function () { return react_2.useConvex; } });
Object.defineProperty(exports, "useConvexAuth", { enumerable: true, get: function () { return react_2.useConvexAuth; } });
Object.defineProperty(exports, "optimisticallyUpdateValueInPaginatedQuery", { enumerable: true, get: function () { return react_2.optimisticallyUpdateValueInPaginatedQuery; } });
...
function hash(queryKey) {
    return `convexQuery|${(0, server_1.getFunctionName)(queryKey[1])}|${JSON.stringify((0, values_1.convexToJson)(queryKey[2]))}`;
}
/**
...
class ConvexQueryClient {
    ...
    options = {}) {
        if (typeof client === "string") {
            this.convexClient = new react_1.ConvexReactClient(client, options);
        }
        else {
        ...
        if (isServer) {
            this.serverHttpClient = new browser_1.ConvexHttpClient(this.convexClient.url);
        }
    }
    ...
    onUpdate = () => {
        ...
        react_query_1.notifyManager.batch(() => {
     ...
     * queries.
     */
    hashFn(otherHashKey = react_query_1.hashKey) {
        return (queryKey) => {
    ...
    queryOptions = (funcRef, queryArgs) => {
        return {
            queryKey: [
                ...
                (0, server_1.getFunctionName)(funcRef),
...
exports.ConvexQueryClient = ConvexQueryClient;
/**
 * Query options factory for Convex query function subscriptions.
